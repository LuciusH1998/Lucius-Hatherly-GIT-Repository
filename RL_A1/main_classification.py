...
def main():
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title(f'{args.model.upper()} Loss Curves')
    plt.legend()
    plt.savefig(os.path.join(args.logdir, 'loss_curve.png'))
    plt.show()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title(f'{args.model.upper()} Curves for Accuracy')
    plt.legend()
    plt.savefig(os.path.join(args.logdir, 'accuracy_curve.png'))
    plt.show()
