...
labels_train_rs = labels_train.reshape(-1)
images_test_rs = images_test.reshape(images_test.shape[0], -1)

# Performing Normalization
images_train_stand = images_train_rs/255.0
images_test_stand = images_test_rs/255.0
...
X_tr, X_val, y_tr, y_val = train_valid_split(images_train_stand, labels_train_rs)
...
def knn_predict(X_train, y_train, X_test, k):
    ...
    for x in X_test:
        sims = X_train @ x                     # cosine similarity (vectors normalized)
...
# ------------------------------------------
y_pred_test_knn = knn_predict(X_tr_norm, y_tr, X_test_norm, k=best_k)
...
# ============================================================
y_pred_test = model.predict(images_test_rs)
