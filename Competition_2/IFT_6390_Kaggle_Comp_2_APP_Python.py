...
print("Original count:", len(images_train_clean))
print("After cleaning:", len(images_train_clean))
print("Removed:", len(images_train) - len(images_train_clean))
...
df_sub.to_csv("logreg_multiclass_submission_11252025.csv", index=False)
print("Kaggle file saved as logreg_multiclass_11252025_submission.csv")
...
file = f"logreg_ovr_tuned_lr{optimal_lr}_iter{optimal_it}_11252025.csv"
